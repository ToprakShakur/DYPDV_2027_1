# Proyecto 3D - Práctica 1 (Unity)

##  Descripción
Este proyecto corresponde a la *Práctica 1 de Laboratorio en Unity 3D* donde se introducen conceptos 
de Movimiento y Camara (Unity 3D)

##  Requisitos
- Unity Hub instalado.
- Editor de Unity 
- Repositorio del alumno configurado.
